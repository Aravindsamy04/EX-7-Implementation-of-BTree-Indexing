...
## STEP 4:
If there is more than one key in the current node and k > the first key, compare k with the next key in the node. If k < next key, search the left child of this key (ie. k lies in between the first and the second keys). Else, search the right child of the key.
...
![280512760-a0988958-d08d-4bf3-a518-f46af62ca388](https://github.com/Aravindsamy04/EX-7-Implementation-of-BTree-Indexing/assets/113497037/7348bcfd-3063-4b47-9bae-1438400f66dd)
